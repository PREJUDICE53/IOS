...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let backBtn = UIButton(frame: CGRect(x: 10, y: 25, width: buttonWidth, height: buttonHeight))
        ...
        let forwardBtn = UIButton(frame: CGRect(x: 20 + buttonWidth, y: 25, width: buttonWidth, height: buttonHeight))
        ...
        let freshBtn = UIButton(frame: CGRect(x: 30 + buttonWidth * 2, y: 25, width: buttonWidth, height: buttonHeight))
